...
import styles from '../styles/ThongKeLoRoiStyle';
...
class ThongKeLoRoiScreen extends React.Component {
    static navigationOptions = {
        title: 'Thống kê lô tô rơi'
    };
    state = {
        regionID: 'tt',
    ...
    getResult = async () => {
        ...
        let result = await callAPI('loto/fallen', {
            ...
            <View style={styles.container}>
                <View style={styles.filterForm}>
                    ...
                    <View style={styles.resultHead}>
                        ...
                        <View style={styles.resultHeadCol}><Text style={styles.resultHeadText}>Số lần về liên tiếp</Text></View>
                    </View>
                </View>
                {this.renderResult()}
        ...
        return (<ScrollView style={styles.resultBodyList}>
            {this.state.results.map((item) => {
                return (<View style={styles.resultBody} key={item.number}>
                    ...
                    <View style={styles.resultHeadCol}><Text style={styles.resultColText}>{item.number_days+1}</Text></View>
                </View>)
            })}
        </ScrollView>);
    };
...
export default connect(mapStateToProps, mapDispatchToProps)(ThongKeLoRoiScreen);
